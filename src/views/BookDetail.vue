        ...
        <div v-if="book" class="book-detail">
          ...
          <div class="book-info">
            <div class="book-header" >
              <h1 :class="{ 'dark-mode': isDark }">{{ book.title }}</h1>
            ...
            <p class="book-author" :class="{ 'dark-mode': isDark }">By {{ book.author }}</p>
            ...
            <div class="book-meta" >
              <p :class="{ 'dark-mode': isDark }"><strong>ISBN:</strong> {{ book.isbn }}</p>
              <p :class="{ 'dark-mode': isDark }"><strong>Quantity:</strong> {{ book.quantity }}</p>
              <p :class="{ 'dark-mode': isDark }"><strong>Availability:</strong> {{ book.quantity - book.borrowedBy.length }} of {{ book.quantity }} available</p>
            </div>
            
            <el-divider />
            
            <div class="book-description">
              <h3 :class="{ 'dark-mode': isDark }">Description</h3>
              <p :class="{ 'dark-mode': isDark }">{{ book.description }}</p>
            </div>
